...
in_layer = 'tl5_l2b_a_044_01_mscaoi'
print('start reading')
...
plt.hist(sent1ges_mean,bins=100, histtype='stepfilled', color='lightgray', label='2015-2021')
plt.hist(sent1AB_mean,bins=100, histtype='stepfilled', alpha=0.4, label='2016-2021 Sent1AB')
plt.hist(sent1A_mean,bins=50, histtype='step', label='2015 - 2016, Sent1A')
plt.legend()
...
plt.figure()
plt.hist(sent1ges_var,bins=600, histtype='stepfilled', color='lightgray', label='2015-2021')
plt.hist(sent1AB_var,bins=600, histtype='stepfilled', alpha=0.4, label='2016-2021 Sent1AB')
plt.hist(sent1A_var,bins=50, histtype='step', label='2015 - 2016, Sent1A')
plt.legend()
plt.xlim([0,200])
plt.title('var')
plt.show()          
